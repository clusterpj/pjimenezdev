...
const projectsEn: Project[] = [
  ...
  {
    id: "social-command", name: "Social Command Center", year: "2026", category: "Automation · AI", cats: ["Automation", "AI"],
    tags: ["Automation", "AI integration", "Telegram bot", "Bun", "SQLite", "fal.ai"],
    status: "production",
    metaTitle: "Social Command Center — Telegram bot that writes and publishes social posts",
    metaDesc: "A Telegram bot that turns a photo or an idea into per-platform copy and AI images with correct on-image text, then publishes to Instagram, LinkedIn, Facebook and X.",
    desc: "Telegram bot that turns a photo or a one-line idea into ready-to-publish social posts — per-platform copy, AI images with correct on-image text, and one-tap publishing to Instagram, LinkedIn, Facebook, and X.",
    problem: "Posting the same promotion to four platforms is four rounds of rewriting, resizing, and reformatting, and it is the first task a small business drops when the week gets busy. The obvious fix — an AI image generator — usually makes it worse: ask most models for a \"30% OFF\" banner and you get confident gibberish, which is unusable for anything commercial.",
    build: "A single Telegram chat as the whole interface, with the model choice treated as a routing decision rather than a fixed dependency.",
    points: [
    ...
    outcome: "Running in production on a single droplet under systemd. A four-platform promo post goes from idea to published in one Telegram exchange, at roughly nine cents when it needs designed text on the image and about a penny when it does not — around $15 to $20 a month all in, including the server.",
    image: "/images/work/social-command/console.webp",
    gallery: ["/images/work/social-command/image-engine.webp", "/images/work/social-command/writing.webp", "/images/work/social-command/api-keys.webp"],
  },
  {
...
const projectsEs: Project[] = [
  ...
  {
    id: "social-command", name: "Social Command Center", year: "2026", category: "Automatización · IA", cats: ["Automation", "AI"],
    tags: ["Automatización", "Integración de IA", "Bot de Telegram", "Bun", "SQLite", "fal.ai"],
    status: "production",
    metaTitle: "Social Command Center — bot de Telegram que escribe y publica en redes",
    metaDesc: "Un bot de Telegram que convierte una foto o una idea en copy por plataforma e imágenes IA con texto correcto, y publica en Instagram, LinkedIn, Facebook y X.",
    desc: "Bot de Telegram que convierte una foto o una idea de una línea en publicaciones listas para redes — copy adaptado a cada plataforma, imágenes IA con texto legible encima y publicación de un toque en Instagram, LinkedIn, Facebook y X.",
    problem: "Publicar la misma promoción en cuatro plataformas son cuatro rondas de reescribir, redimensionar y reformatear, y es la primera tarea que un negocio pequeño abandona cuando la semana se complica. La solución obvia — un generador de imágenes con IA — normalmente lo empeora: pídele a la mayoría de modelos un banner de \"30% OFF\" y te devuelve un galimatías muy seguro de sí mismo, inservible para cualquier uso comercial.",
    build: "Un solo chat de Telegram como toda la interfaz, y la elección de modelo tratada como una decisión de ruteo en lugar de una dependencia fija.",
    points: [
      "Manda una foto con un texto, o /dream una idea desde cero, y el bot escribe el copy ajustado a cada plataforma, genera o edita la imagen y devuelve una sola vista previa con botones de Publicar, regenerar imagen, regenerar texto y ajustar respondiendo.",
      "El ruteo tipográfico es donde está el dinero: lo que no lleva texto encima va a un modelo rápido y barato por menos de un centavo, y solo lo que de verdad necesita letras legibles va al modelo con validación de caracteres por unos nueve centavos. El costo sigue a la intención, no al volumen.",
      "Respaldos en capas en cada llamada externa — la generación de copy cae de OpenRouter a Claude Haiku y luego a DeepSeek directo, y una edición de texto sobre imagen cae a un banner SVG determinista. Una caída de proveedor degrada el resultado en vez de romper el bot.",
      "Modelos, prompts, estilo de marca, relación de aspecto y llaves de API son todos ajustes en tiempo de ejecución guardados en SQLite y editables desde una consola de administración con una franja de salud en vivo. Cambiar de motor de imágenes o reafinar la voz de marca es enviar un formulario, no un redespliegue.",
      "Controles de costo integrados en vez de vigilados después: un tope diario de generaciones por chat acota el peor caso, cada llamada de imagen está fijada a resolución 1K, y una publicación fallida se reintenta contra el material ya generado, así que no cuesta nada extra.",
      "La publicación está aislada detrás de un solo módulo — es el único código que sabe qué plataforma de publicación se usa — y una lista blanca de chats hace que los mensajes de cualquier otro se ignoren por completo.",
    ],
    outcome: "Corriendo en producción en un solo droplet bajo systemd. Una promoción para cuatro plataformas pasa de idea a publicada en un solo intercambio de Telegram, por unos nueve centavos cuando necesita texto diseñado sobre la imagen y cerca de un centavo cuando no — entre $15 y $20 al mes con todo incluido, servidor aparte de nada.",
    image: "/images/work/social-command/console.webp",
    gallery: ["/images/work/social-command/image-engine.webp", "/images/work/social-command/writing.webp", "/images/work/social-command/api-keys.webp"],
  },
  {
...
const en = {
  ...
  notFound: {
    ...
    message: "The work does, though — seven shipped projects, five of them live with real users.",
  ...
  work: {
    metaTitle: "Work — 7 shipped projects | Pedro Jimenez, full-stack + AI developer",
    ...
    eyebrow: "// work — 7 projects, 5 live in production",
  ...
  about: {
    ...
    p1: "Based in Santiago, Dominican Republic. I ship AI integrations, automations, and full-stack web and mobile apps — production-grade, fast, without the agency overhead. Seven projects shipped, five of them live in production with real users.",
...
const es: typeof en = {
  ...
  notFound: {
    ...
    message: "El trabajo sí — siete proyectos entregados, cinco de ellos en vivo con usuarios reales.",
  ...
  work: {
    metaTitle: "Proyectos — 7 proyectos entregados | Pedro Jimenez, desarrollador full-stack + IA",
    ...
    eyebrow: "// proyectos — 7 proyectos, 5 en producción",
  ...
  about: {
    ...
    p1: "Desde Santiago, República Dominicana. Entrego integraciones de IA, automatizaciones y apps web y móviles completas — calidad de producción, rápido, sin la carga de una agencia. Siete proyectos entregados, cinco de ellos en producción con usuarios reales.",

...
const projectsEs: Project[] = [
  ...
  },
  {
    id: "c21-perdomo", name: "C21 Perdomo", year: "2026", category: "Web app", cats: ["Web"],
    tags: ["Next.js 16", "TypeScript", "WordPress", "next-intl", "Railway", "Cloudflare"],
    desc: "Vitrina headless en Next.js sobre el catálogo WordPress existente de Century 21, sirviendo propiedades en español, inglés, francés y alemán — donde el enrutamiento y el SEO son la arquitectura, no una idea tardía.",
    ...
    build: "Un frontend headless en Next.js sobre el catálogo WordPress que el equipo ya conocía — pero con el enrutamiento y el SEO construidos como arquitectura, no como idea tardía.",
    points: [
    ...
    outcome: "En producción en c21perdomo.com — un sitio inmobiliario multilingüe que aparece en búsquedas en sus cuatro mercados de idioma, sobre un CMS legacy que nunca fue construido para uso headless. Lo difícil no fueron las traducciones; fue asegurarse de que Google entendiera cada página en cada idioma.",
  },
  {
